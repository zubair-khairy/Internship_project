        ...
        <section class="section">
            ...
            <div class="row justify-content-center">
                ...
                <div class="card-body">
                    ...
                    <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Create Employee</h5>
                    <p class="text-center small">Enter your details of Employee</p>
                    </div>
            
                    <form class="row g-3 needs-validation"  enctype="multipart/form-data" novalidate  method="post" action="{{route('employees.store')}}">
                     @csrf
                     @method('POST')
                    <div class="col-12">
                        <label for="Employee_first_name" class="form-label">Employee first_name </label>
